...
class NavigationService {
  ...
  factory  NavigationService.navigate() => _instance;
  ...
  Future<dynamic> removeScreenUntil(Widget page, {arguments}) async => navigationKey.currentState?.pushAndRemoveUntil(
    MaterialPageRoute(
      builder: (_) => page,
    ),
        (route) => false,
