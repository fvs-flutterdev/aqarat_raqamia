...
class PaginatedListView extends StatefulWidget {
  ...
  final bool reverse;
  final bool isChat;
  const PaginatedListView({ required this.scrollController, required this.onPaginate, required this.totalSize, required this.last,
    this.isChat=true,
...
class _PaginatedListViewState extends State<PaginatedListView> {
  ...
  //  if (_offset! < pageSize && !_offsetList!.contains(_offset!+1))
    if(widget.offset<=widget.last.toInt())
    {
