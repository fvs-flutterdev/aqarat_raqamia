...
class HorizontalLivingRoom extends StatelessWidget {
  const HorizontalLivingRoom({super.key});
          ...
          child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    addRealAdsCubit.changeLivingRoomStatus(index: index);
                  },
                  child: Column(
                      ...
                      Card(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(
                                Dimensions.RADIUS_LARGE.sp)),
                        color: darkGreyColor,
                        child: Container(
                            margin: EdgeInsets.all(addRealAdsCubit
                                        .resourceCreateModel.livingRoom?.last ==
                                    true
