...
class CompletePayments extends StatefulWidget {
...
class _CompletePaymentState extends State<CompletePayments> {
  void listenChatChannel() {
    LaravelEcho.instance
        .channel('payment-channel')
        .listen('.new-subscription-${userId}', (e) {
      if (e is PusherEvent) {
        if (e.data != null) {
          jsonDecode(e.data!);
          ...
          child: Scaffold(
            ...
            body: Container(
              child: subscribeCubit.loading
                  ...
                  subscribeCubit.paymentResponseModel.paymentDetails?.message ==
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              PaymentDetailsWidget(
                                bidDuration: subscribeCubit.paymentResponseModel
                                        .paymentDetails?.data?.bidDuration ??
                                    '',
                                price: subscribeCubit.paymentResponseModel
                                        .paymentDetails?.data?.price ??
                                    '',
                                type: subscribeCubit.paymentResponseModel
                                        .paymentDetails?.data?.type ??
                                    '',
                                orderNumber: subscribeCubit.paymentResponseModel
                                        .paymentDetails?.data?.orderNumber ??
                                    '',
                                transaction: subscribeCubit.paymentResponseModel
                              ...
                              CustomButton(
                                ...
                                onPressed: () async {
                                  if (subscribeCubit.paymentResponseModel
