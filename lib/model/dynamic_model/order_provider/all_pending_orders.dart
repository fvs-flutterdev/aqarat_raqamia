class AllPendingOrdersProviders {
  List<PendingOrdersProvider>? data;
  Links? links;
  Meta? meta;

  AllPendingOrdersProviders({this.data, this.links, this.meta});

  AllPendingOrdersProviders.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <PendingOrdersProvider>[];
      json['data'].forEach((v) {
        data!.add(new PendingOrdersProvider.fromJson(v));
      });
    }
 ...
 //"isSent": true
  ...
  PendingOrdersProvider(
      ...
      //  this.acceptedPriceOffers,
        this.priceOffers,
        this.createDates,
        this.updateDates,this.isSent});

  PendingOrdersProvider.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    orderType=json['type'];
...
class PendingServicesLinks {
  String? url;
  String? label;
  bool? active;

  PendingServicesLinks({this.url, this.label, this.active});

  PendingServicesLinks.fromJson(Map<String, dynamic> json) {
    url = json['url'];
    label = json['label'];
    active = json['active'];
  }
