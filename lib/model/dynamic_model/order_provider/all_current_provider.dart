class AllCurrentOrdersProvider {
  List<CurrentOrdersProviders>? data;
  Links? links;
  Meta? meta;

  AllCurrentOrdersProvider({this.data, this.links, this.meta});

  AllCurrentOrdersProvider.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <CurrentOrdersProviders>[];
      json['data'].forEach((v) {
        data!.add(new CurrentOrdersProviders.fromJson(v));
      });
    }
...
class CurrentOrdersProviders {
  ...
  CurrentOrdersProviders.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class UserRequestServices {
  ...
  UserRequestServices({this.id, this.name, this.photo,this.rate});
...
class CurrentOrdersLinks {
  String? url;
  String? label;
  bool? active;

  CurrentOrdersLinks({this.url, this.label, this.active});

  CurrentOrdersLinks.fromJson(Map<String, dynamic> json) {
    url = json['url'];
    label = json['label'];
    active = json['active'];
  }
