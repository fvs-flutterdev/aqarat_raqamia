class FinishedOrderClientModel {
  List<Data>? data;
  Links? links;
  Meta? meta;

  FinishedOrderClientModel({this.data, this.links, this.meta});

  FinishedOrderClientModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class FinishedOrderLinks {
  String? url;
  String? label;
  bool? active;

  FinishedOrderLinks({this.url, this.label, this.active});

  FinishedOrderLinks.fromJson(Map<String, dynamic> json) {
    url = json['url'];
    label = json['label'];
    active = json['active'];
  }
